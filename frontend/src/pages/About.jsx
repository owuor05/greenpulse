    ...
    <div className="min-h-screen font-sans">
      ...
      <section className="relative py-20 px-4 overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto text-center z-10">
          <h1 className="text-5xl font-bold mb-6 text-blac drop-shadow-lg">
            About GreenPulse
          </h1>
          <p className="text-2xl text-green-100 drop-shadow">
            GreenPulse is a B2B climate intelligence platform that helps
            companies analyze emissions, understand how their activities affect
            different regions, and use AI-driven insights to manage climate
            risk, compliance, and environmental impact.
          </p>
        </div>
      </section>
      ...
      <section className="relative py-16 px-4 overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto z-10">
          ...
          <p className="text-xl text-green-100 leading-relaxed text-center mb-8">
            GreenPulse exists to provide businesses, communities, and
            decision-makers with climate data and AI-driven intelligence to
            understand, manage, and reduce environmental and climate impact
            across Kenya.
          </p>
          <div className="bg-white/95 backdrop-blur-sm border-l-4 border-green-600 p-6 rounded-r-lg">
            <p className="text-lg text-gray-800 italic">
              ...
              GreenPulse combines climate datasets, AI reasoning, and human
              insight to help businesses reduce environmental risk and help
          ...
          <div className="space-y-8">
            ...
            <div className="flex gap-6 items-start">
              ...
              <div>
                ...
                <p className="text-gray-300">
                  Climate intelligence delivered via Telegram bot and our web
                  platform. Access insights wherever you work.
                </p>
              </div>
            </div>
