...
function AIPage() {
  ...
  const send = async () => {
    ...
    try {
      ...
      // Get the response - handle different response formats
      let fullAnswer = data.answer || data.response || data.message || "I received your request but couldn't generate a response.";
      
      // If document was analyzed, prepend document info
      if (selectedFile && data.document_summary) {
        fullAnswer = `**📄 Document Analysis: ${selectedFile.name}**\n\n${data.document_summary}\n\n---\n\n${fullAnswer}`;
      }
      ...
      // If file upload failed, provide helpful message
      if (selectedFile && errorMessage.includes("Not Found")) {
        errorMessage = "Document analysis is not available on this server. Please try without attaching a file, or contact support.";
      }
    ...
    <div className="min-h-screen font-sans">
        ...
        <div className="fixed inset-0 z-50 bg-gray-900/95 backdrop-blur-sm flex flex-col">
          ...
          <div className="flex items-center justify-between px-6 py-4 border-b border-gray-700">
            <div className="flex items-center gap-3">
              ...
              <span className="text-white font-semibold">GreenPulse AI Assistant</span>
            </div>
            ...
            <div className="max-w-4xl mx-auto space-y-6">
              {messages.length === 0 && !loading && !error && (
                <div className="text-gray-400 text-center mt-20">
                  <p className="text-lg mb-2 font-semibold font-weight-bold">Ask me about:</p>
              ...
              {messages.map((m, idx) => (
                ...
                >
                  <div className={`max-w-[80%] ${m.role === "user" ? "text-right" : "text-left"}`}>
                    {m.role === "assistant" && (
                      <div className="text-xs text-green-400 mb-1 px-1">GreenPulse AI</div>
                    )}
                        ...
                        <div className="prose prose-invert prose-sm max-w-none">
                          <ReactMarkdown
                            components={{
                              ...
                              h3: ({node, ...props}) => <h3 className="text-base font-semibold text-gray-200 mt-2 mb-1" {...props} />,
                              ...
                              blockquote: ({node, ...props}) => <blockquote className="border-l-4 border-green-500 pl-3 italic text-gray-400 my-2" {...props} />,
                              code: ({node, ...props}) => <code className="bg-gray-700 px-1 py-0.5 rounded text-sm" {...props} />,
                            }}
                          >
                            {m.content}
                          </ReactMarkdown>
            ...
            <div className="max-w-4xl mx-auto">
              ...
              {selectedFile && !processingFile && (
                <div className="mb-3 flex items-center gap-2 p-2 bg-green-900/50 border border-green-700 rounded-lg">
                  ...
                  <span className="text-xs text-green-400">({(selectedFile.size / 1024 / 1024).toFixed(2)} MB)</span>
                  <button onClick={removeFile} className="text-red-400 hover:text-red-300 p-1" title="Remove file">
              ...
              <div className="flex items-end gap-3">
                <div className="flex-1 relative">
                  ...
                  <button
                    ...
                    title={selectedFile ? "Change document" : "Attach PDF document for AI analysis"}
                    disabled={processingFile}
                  >
                    <svg 
                      xmlns="http://www.w3.org/2000/svg" 
                ...
                >
                  {processingFile ? "Processing..." : loading ? "Sending..." : "Send"}
                </button>
              </div>
      ...
      <section className="relative py-20 px-4 overflow-hidden">
        ...
        <div className="relative max-w-5xl mx-auto text-center z-10">
          <h1 className="text-5xl md:text-6xl font-bold mb-3 text-black drop-shadow-lg">GreenPulse AI Assistant</h1>
                      ...
                      >
                        {m.role === "assistant" ? (
                          <div className="prose prose-sm max-w-none">
                            <ReactMarkdown
                              components={{
                                h1: ({node, ...props}) => <h1 className="text-xl font-bold text-gray-900 mt-3 mb-2" {...props} />,
                                ...
                                em: ({node, ...props}) => <em className="italic" {...props} />,
                                blockquote: ({node, ...props}) => <blockquote className="border-l-4 border-green-500 pl-3 italic text-gray-600 my-2" {...props} />,
            ...
            {processingFile && (
              <div className="mb-3 flex items-center gap-2 p-3 bg-blue-50 border border-blue-200 rounded-lg">
                ...
                <span className="text-sm text-blue-700">
                  📄 Analyzing your document... The AI is reading and processing the content. This may take a moment.
                </span>
              </div>
            )}
      ...
      <section className="relative py-16 px-4 overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto text-center z-10">
          ...
          <p className="text-xl text-gray-200 mb-8">
            Get instant answers to your land conservation questions from our advanced AI assistant
          </p>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="text-center">
              <div className="text-4xl font-bold text-green-400 mb-2">Expert</div>
